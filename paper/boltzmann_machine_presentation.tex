...
\frame{
    ...
    \begin{itemize}
        ...
        \item how did we prepare it (binary representation)
    \end{itemize}
}
...
\frame{
    ...
    \begin{itemize}
        \item Explain our experiment setup and what we wanted to show
    \end{itemize}
}
...
\frame{
    \frametitle{Results}
    \begin{itemize}
        \item Result graph with explanation
    \end{itemize}
}
...
\frame{
    ...
    \begin{itemize}
        \item What problems could we not solve
        \item What would be interesting to investigate?
    \end{itemize}
}
