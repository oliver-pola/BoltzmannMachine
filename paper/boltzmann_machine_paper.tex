...
\begin{itemize}
    ...
    \item \textbf{Synchronous update flag}: Lastly it can be decided if the asynchronous or
...
In this paper we introduced the Boltzmann machine. We have seen a very different approach to neural networks which is not exactly new but 
...
bring the reader a good understanding of the core concept of the Boltzmann machine and how it could be used in practice.
...
In conclusion we can say that the Boltzmann machine is a very different but interesting approach to machine learning
but further study is still needed to unlock more of its potential.
