...
We conclude that in general the Boltzmann machine takes a long time to train and it is necessary but hard to tune the parameters to the specific problem.
}
